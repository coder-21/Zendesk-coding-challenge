...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      File file = new File("./src/resources/organizations.json");
      ...
      File ticketFile = new File("./src/resources/tickets.json");
      ...
      File usersFile = new File("./src/resources/users.json");
